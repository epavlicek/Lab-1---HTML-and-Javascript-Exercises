...
const Product = class Product {
    ...
    static inStock = (products) => {
        const newProducts = products.filter(element=> element.availability === 'In Stock');
        return newProducts;
    ...
    static halfOff = (products) => {
        const newPrice = products.map((element)=> element.price * 0.5);
        return newPrice;
    }
    ...
    static printProducts = (products) => {
       ...
       // if (products.availability == "In Stock" ){
        ...
        console.log("Product: "+ this.name +  ", Cost: $" + n + ", Available: Yes");
       // else 
         //   console.log("Product: "+ this.name +  ", Cost: $" + n + ", Available: No");
